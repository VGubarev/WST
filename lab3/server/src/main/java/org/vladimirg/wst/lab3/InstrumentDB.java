...
public class InstrumentDB {
    ...
    public Integer createInstrument(InstrumentFields instrumentFields) throws DatabaseFailureException {
        ...
        try {
            ...
            throw new org.vladimirg.wst.lab3.exceptions.DatabaseFailureException("Failed to create instrument", fault);
        }
        ...
        try {
            ...
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab3.exceptions.DatabaseFailureException("Failed to get inserted instrument id", fault);
        }
    ...
    public OperationStatus updateInstrument(InstrumentFields instrumentFields) throws IllegalArgumentException, DatabaseFailureException {
        ...
        if (id == null) {
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            throw new org.vladimirg.wst.lab3.exceptions.IllegalArgumentException("id is empty", fault);
        }
        ...
        try {
            ...
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab3.exceptions.DatabaseFailureException("Failed to get database handle", fault);
        }
        ...
        try {
            ...
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab3.exceptions.DatabaseFailureException("Failed to update instrument", fault);
        }
    ...
    public OperationStatus deleteInstrument(InstrumentFields instrumentFields) throws IllegalArgumentException, DatabaseFailureException {
        ...
        if (id == null) {
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            throw new org.vladimirg.wst.lab3.exceptions.IllegalArgumentException("Instrument identifier is required to delete instrument", fault);
        }
        ...
        try {
            ...
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab3.exceptions.DatabaseFailureException("Failed to delete instrument", fault);
        }
    ...
    public List<Instrument> getInstruments(InstrumentFields instrumentFields) throws DatabaseFailureException {
        ...
        try {
            ...
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab3.exceptions.DatabaseFailureException("Failed to get result set", fault);
        }
    }
