...
import org.vladimirg.wst.lab4.standalone.exceptions.InstrumentServiceFault;
import org.vladimirg.wst.lab4.standalone.exceptions.IllegalArgumentException;
...
public class InstrumentDB {
    ...
    public Integer createInstrument(InstrumentFields instrumentFields) throws DatabaseFailureException {
        ...
        try {
            ...
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab4.standalone.exceptions.DatabaseFailureException("Failed to create instrument", fault);
        }
        ...
        try {
            ...
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab4.standalone.exceptions.DatabaseFailureException("Failed to get inserted instrument id", fault);
        }
    ...
    public OperationStatus updateInstrument(InstrumentFields instrumentFields) throws IllegalArgumentException, DatabaseFailureException {
        Integer id = instrumentFields.getId();

        if (id == null) {
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            throw new org.vladimirg.wst.lab4.standalone.exceptions.IllegalArgumentException("id is empty", fault);
        }
        ...
        try {
            ...
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab4.standalone.exceptions.DatabaseFailureException("Failed to get database handle", fault);
        }
        ...
        try {
            ...
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab4.standalone.exceptions.DatabaseFailureException("Failed to update instrument", fault);
        }

        return new OperationStatus(false, "No instruments updated");
    }

    public OperationStatus deleteInstrument(InstrumentFields instrumentFields) throws IllegalArgumentException, DatabaseFailureException {
        Integer id = instrumentFields.getId();
        if (id == null) {
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            throw new org.vladimirg.wst.lab4.standalone.exceptions.IllegalArgumentException("Instrument identifier is required to delete instrument", fault);
        }
        ...
        try {
            ...
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab4.standalone.exceptions.DatabaseFailureException("Failed to delete instrument", fault);
        }
    ...
    public List<Instrument> getInstruments(InstrumentFields instrumentFields) throws DatabaseFailureException {
        ...
        try {
            ...
            InstrumentServiceFault fault = InstrumentServiceFault.defaultInstance();
            fault.setMessage(e.getSQLState());
            throw new org.vladimirg.wst.lab4.standalone.exceptions.DatabaseFailureException("Failed to get result set", fault);
        }
    }
