 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://lab1_server.wst.vladimirg.com/", wsdlLocation = "http://localhost:8080/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://lab1_server.wst.vladimirg.com/", "PersonService");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://lab1_server.wst.vladimirg.com/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1_server.wst.vladimirg.com/", "PersonWebServicePort"), PersonWebService.class, features);
    }
